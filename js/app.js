...
let farah = calcAge(15, 7, 2006);
document.getElementById("f_age").innerHTML =
  " " + farah.y + " year " + farah.m + " month " + farah.d + " day";
document.getElementById(
  "f_next_birthday"
).innerHTML = ` ${days} until your birthday  `;
let yossef = calcAge(5, 6, 2005);

document.getElementById("y_age").innerHTML =
  " " + yossef.y + " year " + yossef.m + " month " + yossef.d + " day";
document.getElementById(
  "y_next_birthday"
).innerHTML = ` ${days}   until your birthday`;

let us = calcAge(15, 8, 2019);

document.getElementById("year_number").innerHTML =
  " " + us.y + " year " + us.m + " month " + us.d + " day ";

document.getElementById("month_number").innerHTML = `${
  us.y * 12 + us.m
} month ${us.d} day  `;
